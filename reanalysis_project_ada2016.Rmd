...
p
```
The columns are colored by the stimulus type used. The dark red columns are all from the habituating bat, and the orange column is the response to the test bat. 
...
p      
```
The columns are colored by the stimulus type used. The dark teal columns are all from the habituating bat, and the green column is the response to the test bat. 

This is the corresponding chart in Carter et al.:

<img src="img/GC_Fig4.png" width="200px"/>
